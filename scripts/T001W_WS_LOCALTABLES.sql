	...
	(
		SELECT DISTINCT
		 ...
		 DL."Latitude" AS LAT_TMP,
	 	 ...
	 	 ROW_NUMBER() over (PARTITION BY TW.WERKS ORDER BY NEW ST_Point(DL."Longitude", DL."Latitude").ST_Distance(SP.SHAPE) ASC, TO_NUMBER(DL."1st Max Value") DESC) AS ROWNUM,
