jQuery.sap.require("live4.util.Formatter");

sap.ui.core.mvc.Controller.extend("live4.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "live4.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	selectFirstItem : function() {
		...
		if (aItems.length) {
    		...
    		this.getRouter().myNavToWithoutHash({ 
    			currentView : this.getView(),
    			targetViewName : "live4.view.NotFound",
    			targetViewType : "XML"
        	});
		}
	},
