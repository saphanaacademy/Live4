jQuery.sap.require("live4IoT.util.Formatter");

sap.ui.core.mvc.Controller.extend("live4IoT.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "live4IoT.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("NAME1", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
	...
	onReset: function() {
		...
		$.ajax({
			url: jQuery.sap.getModulePath("live4IoT") + "/destinations/live4/services.xsjs?cmd=reset",
			type: "get",
			async: false,
			error: function() {
